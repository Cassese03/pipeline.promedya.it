    ...
    <section class="content" style="padding: 0 1.5rem 1.5rem;">
        @if ($utente->username == 'Giovanni Tutino')
            <div style="margin-bottom: 1.5rem;">
                <button class="btn btn-primary" style="padding: 0.75rem 2rem;" id="aggiungi_segnalato" onclick="aggiungi()">
                    <i class="fas fa-plus" style="margin-right: 0.5rem;"></i>
                    Aggiungi Nuovo Segnalato
                </button>
            </div>
        @endif
        ...
        <div class="card animate-fadeIn">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-user-tag" style="margin-right: 0.5rem;"></i>Elenco Segnalati</h3>
            </div>
            <div class="card-body">
                <style>
                    #example3_wrapper {
                        ...
                        <tr>
                            ...
                            <td class="no-sort" style="text-align: center; white-space: nowrap;">
                                ...
                                @else
                                    ...
                                    <button type="button" onclick="eliminaSegnalato(<?php echo $p->id;?>)"
...
<form method="post" enctype="multipart/form-data" action="/segnalato">
    @csrf
    <div class="modal fade" id="modal_modifica_<?php echo $p->id;?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Modifica Segnalazione</h4>
...
<form method="post" onsubmit="return confirm('Sei sicuro di voler aggiungere il nuovo segnalato?')" enctype="multipart/form-data" action="/segnalato">
    @csrf
    <div class="modal fade" id="modal_aggiungi">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Crea Segnalato</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
